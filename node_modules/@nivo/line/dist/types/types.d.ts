...
import { Dimensions, Box, MotionProps, CssMixBlendMode, ValueFormat, SvgDefsAndFill, CartesianMarkerProps, PropertyAccessor, LineCurveFactoryId, DotsItemSymbolComponent } from '@nivo/core';
...
export type InferSeriesId<T> = T extends {
    id: infer Id;
} ? Id : never;
...
export declare function isPoint<Series extends LineSeries>(data: PointOrSliceData<Series>): data is Point<Series>;
export declare function isSliceData<Series extends LineSeries>(data: PointOrSliceData<Series>): data is SliceData<Series>;
export interface DataProps<Series extends LineSeries> {
    data: readonly Series[];
}
export type LineGenerator = Line<{
    x: number;
    y: number;
}>;
export type AreaGenerator = Area<{
    x: number;
    y: number;
}>;
...
export type PointTooltipComponent<Series extends LineSeries> = FunctionComponent<PointTooltipProps<Series>>;
export interface SliceTooltipProps<Series extends LineSeries> {
    axis: 'x' | 'y';
    slice: SliceData<Series>;
}
export type SliceTooltipComponent<Series extends LineSeries> = FunctionComponent<SliceTooltipProps<Series>>;
export type PointOrSliceMouseHandler<Series extends LineSeries> = (datum: Readonly<Point<Series>> | Readonly<SliceData<Series>>, event: MouseEvent) => void;
export type PointOrSliceTouchHandler<Series extends LineSeries> = (datum: Readonly<Point<Series>> | Readonly<SliceData<Series>>, event: TouchEvent) => void;
export type LineLayerId = 'grid' | 'markers' | 'axes' | 'areas' | 'crosshair' | 'lines' | 'slices' | 'points' | 'mesh' | 'legends';
...
export type LineCustomCanvasLayer<Series extends LineSeries> = (context: CanvasRenderingContext2D, props: LineCustomCanvasLayerProps<Series>) => void;
...
export type LineSvgProps<Series extends LineSeries> = DataProps<Series> & Dimensions & Partial<CommonLineProps<Series>> & Partial<LineSvgExtraProps<Series>> & SvgDefsAndFill<any>;
export type LineSvgPropsWithDefaults<Series extends LineSeries> = DataProps<Series> & Dimensions & CommonLineProps<Series> & LineSvgExtraProps<Series> & SvgDefsAndFill<any>;
...
export type LineCanvasProps<Series extends LineSeries> = DataProps<Series> & Dimensions & Partial<CommonLineProps<Series>> & Partial<LineCanvasExtraProps<Series>>;
export type LineCanvasPropsWithDefaults<Series extends LineSeries> = DataProps<Series> & Dimensions & CommonLineProps<Series> & LineCanvasExtraProps<Series>;
