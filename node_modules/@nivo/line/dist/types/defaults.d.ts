...
export declare const commonDefaultProps: Omit<CommonLineProps<DefaultSeries>, 'data' | 'xFormat' | 'yFormat' | 'layers' | 'width' | 'height' | 'margin' | 'theme' | 'pointSymbol' | 'gridXValues' | 'gridYValues' | 'axisTop' | 'axisRight' | 'onMouseEnter' | 'onMouseMove' | 'onMouseLeave' | 'onMouseDown' | 'onMouseUp' | 'onClick' | 'onDoubleClick' | 'onTouchStart' | 'onTouchMove' | 'onTouchEnd'> & {
    layers: LineLayerId[];
};
